...
// Key Images (Desktop Logo, Mobile Logo and Favicon)
	$wp_customize->add_section( 'tn_theme_images_section', array(
		'title'    	=> __( 'Logos', 'tn_' ),
		//'description' 	=> __( 'add the URLs for key images below', 'tn_' ),
		'priority' 	=> 30,
	) );
	// inputs
	$wp_customize->add_setting( 'tn_theme_image_logo_large' );
	...
	$wp_customize->add_setting( 'tn_theme_image_logo_medium' );
	...
	$wp_customize->add_setting( 'tn_theme_image_logo_small' );
	...
	$wp_customize->add_setting( 'tn_theme_image_logo_desktop_width', array( 'default' => '100px' ) );
	$wp_customize->add_control( 'tn_theme_image_logo_desktop_width', array(
		'label' 		=> __( 'Medium-up Screen Logo Width', 'tn_' ),
		'section' 	=> 'tn_theme_images_section',
		'type' 		=> 'text'
	) );
	...
	$wp_customize->add_control( 'tn_theme_image_logo_small_width', array(
		'label' 		=> __( 'Small Screen Logo Width', 'tn_' ),
		'section' 	=> 'tn_theme_images_section',
		'type' 		=> 'text'
	) );
	...
	$wp_customize->add_control( 'tn_theme_image_logo_small_padding', array(
		'label' 		=> __( 'Small Screen Logo Padding', 'tn_' ),
		'section' 	=> 'tn_theme_images_section',
		'type' 		=> 'text'
	) );
...
// Theme BG
	$wp_customize->add_section( 'tn_theme_bg_section', array(
		'title' 		=> 'Theme Background',
		'priority' 	=> 40,
	) );
	// inputs
	$wp_customize->add_setting( 'tn_theme_bg_color', array( 'default' => '#FFFFFF', 'sanitize_callback' => 'sanitize_hex_color', ) );
	$wp_customize->add_control( new WP_Customize_Color_Control(  $wp_customize, 'tn_theme_bg_color', array(
		'label' 		=> __( 'Background Color', 'tn_' ),
		'section' 	=> 'tn_theme_bg_section',
		'priority' 	=> 50,
	) ) );
	$wp_customize->add_setting( 'tn_theme_bg_image', array( 'default' => esc_url( get_bloginfo( 'template_url' ) ).'/images/bg_image.png' ) );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'tn_theme_bg_image', array(
		'label' 		=> __( 'Background Image', 'tn_' ),
		'section' 	=> 'tn_theme_bg_section',
		'priority' 	=> 60,
	) ) );
	$wp_customize->add_setting( 'tn_theme_bg_position', array( 'default' => 'center center' ) );
	$wp_customize->add_control( 'tn_theme_bg_position', array(
		'label' 		=> __( 'Background Position', 'tn_' ),
		'section' 	=> 'tn_theme_bg_section',
		'type' 		=> 'text',
		'priority' 	=> 70,
	) );
	$wp_customize->add_setting( 'tn_theme_bg_repeat', array( 'default' => 'no-repeat' ) );
	$wp_customize->add_control( 'tn_theme_bg_repeat', array(
		'label' 		=> __( 'Background Repeat', 'tn_' ),
		'section' 	=> 'tn_theme_bg_section',
		'type' 		=> 'text',
		'priority' 	=> 80,
	) );
	$wp_customize->add_setting( 'tn_theme_bg_size', array( 'default' => 'cover' ) );
	$wp_customize->add_control( 'tn_theme_bg_size', array(
...
// Header
	...
	// inputs
	$wp_customize->add_setting( 'tn_theme_header_show' );
	$wp_customize->add_control( 'tn_theme_header_show', array(
		'label' 		=> 'Show Logo Row',
		'section' 	=> 'tn_theme_header_section',
		'type' 		=> 'checkbox',
		'priority' 	=> 10,
	) );
	$wp_customize->add_setting( 'tn_theme_header_height_type', array( 'default' => 'height', ) );
	$wp_customize->add_control( 'tn_theme_header_height_type', array(
		'label' 		=> 'Height Type',
		'section' 	=> 'tn_theme_header_section',
		'type' 		=> 'radio',
	...
	$wp_customize->add_setting( 'tn_theme_header_overflow' );
	$wp_customize->add_control( 'tn_theme_header_overflow', array(
	...
	$wp_customize->add_setting( 'tn_theme_header_bg_color', array( 'default' => '#FFFFFF', 'sanitize_callback' => 'sanitize_hex_color', ) );
	$wp_customize->add_control( new WP_Customize_Color_Control(  $wp_customize, 'tn_theme_header_bg_color', array(
		'label' 		=> __( 'Background Color', 'tn_' ),
		'section' 	=> 'tn_theme_header_section',
		'priority' 	=> 50,
	) ) );
	$wp_customize->add_setting( 'tn_theme_header_bg_image', array( 'default' => esc_url( get_bloginfo( 'template_url' ) ).'/images/bg_image.png' ) );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'tn_theme_header_bg_image', array(
		'label' 		=> __( 'Background Image', 'tn_' ),
		'section' 	=> 'tn_theme_header_section',
		'priority' 	=> 60,
	) ) );
